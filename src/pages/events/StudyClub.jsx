...
import Askar from "../../assets/images/pengurus/divisiEdukasi/Askar.webp";
...
// Data Timeline Study Club 2026
const timelineData = [
  {
    date: "15 April 2026",
    title: "Open Recruitment Kepanitiaan",
    desc: "Pendaftaran untuk anggota kepanitiaan program kerja Study Club 2026 resmi dibuka.",
    status: "Done",
  },
  {
    date: "02 Mei 2026",
...
// Data Capaian Kegiatan Study Club 2026
      ...
      <div className="max-w-7xl mx-auto space-y-24 relative z-10">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-8 space-y-8 text-center lg:text-left">
            ...
            >
              Study Club <br className="hidden lg:block" />
            ...
            >
              Study Club merupakan komunitas yang dimana sebagai wadah bagi
              Mahasiswa Sistem Informasi untuk menampung, membina, dan
              mengembangkan minat dan bakat Mahasiswa secara intensif dan
              menambah keahlian yang dimiliki oleh Mahasiswa Sistem Informasi di
              bidang akademik dalam ruang lingkup teknologi. Agenda dari Study
              Club yaitu ada Pertemuan Batch dengan total 8 pertemuan per bidang
              dan 1 kali pertemuan Workshop.
            </motion.p>
          ...
          >
            <div className="w-full max-w-sm p-6 rounded-[2rem] bg-white/5 border border-white/10 backdrop-blur-lg shadow-2xl relative group hover:border-accent/30 transition-all duration-500 overflow-hidden">
              ...
              <div className="aspect-[4/5] w-full rounded-2xl overflow-hidden mb-6 border border-white/10 relative">
                <img
                  src={Askar}
                  alt="Ketua Pelaksana Study Club 2026"
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-white/50 font-medium">
                  Ketua Pelaksana Study Club 2026
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <section id="capaian" className="space-y-16 pt-16">
          <div className="text-center space-y-4">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-white flex items-center justify-center gap-3">
              ...
              Pencapaian Kegiatan Study Club 2026
            </h2>
          </div>
