...
import Florencia from "../../assets/images/pengurus/divisiInternal/Florencia.webp";
...
// Data Timeline Revoist 6.0
const timelineData = [
  {
    date: "15 April 2026",
    title: "Open Recruitment Kepanitiaan",
    desc: "Pendaftaran untuk anggota kepanitiaan program kerja Revoist 6.0 resmi dibuka.",
    status: "Done",
  },
  {
    date: "02 Mei 2026",
...
// Data Capaian Kegiatan Revoist 6.0
...
export default function RevoistPage() {
      ...
      <div className="max-w-7xl mx-auto space-y-24 relative z-10">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-8 space-y-8 text-center lg:text-left">
            ...
            >
              Revoist <br className="hidden lg:block" />
            ...
            >
              Revoist 6.0 merupakan perayaan Dies Natalis Himsika yang ke-6
              dengan mengusung tema “Symphony in Celebration of Lights, Laughs,
              and Legacy” yang menggambarkan sebuah momen selebrasi penuh
              harmoni, layaknya alunan musik yang meriah.
            </motion.p>
          ...
          >
            <div className="w-full max-w-sm p-6 rounded-[2rem] bg-white/5 border border-white/10 backdrop-blur-lg shadow-2xl relative group hover:border-accent/30 transition-all duration-500 overflow-hidden">
              ...
              <div className="aspect-[4/5] w-full rounded-2xl overflow-hidden mb-6 border border-white/10 relative">
                <img
                  src={Florencia}
                  alt="Ketua Pelaksana Revoist 6.0"
        ...
        <section id="capaian" className="space-y-16 pt-16">
          <div className="text-center space-y-4">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-white flex items-center justify-center gap-3">
              ...
              Pencapaian Kegiatan Revoist 6.0
            </h2>
          </div>
